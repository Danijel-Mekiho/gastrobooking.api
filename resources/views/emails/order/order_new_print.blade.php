...
<div>
    <TABLE width=800 BORDER=3 CELLPADDING=4 CELLSPACING=0>
        ...
        <TR><TD>
                ...
                <?php echo ($order->delivery_address && $order->delivery_phone) ? $order->delivery_address . ", ".Lang::get("main.MAIL.PICK UP")." - " . $order->delivery_latitude . ", ".Lang::get("main.MAIL.LONGITUDE")." - " . $order->delivery_longitude
                        : $restaurant->name; ?><BR>
            </TD></TR>
        <TR><TD>
